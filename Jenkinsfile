 ...
 * along with pragmatickm-procedure-bom.  If not, see <https://www.gnu.org/licenses/>.
 */
...
def upstreamProjects = [
  ...
  // BOM
  'all', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-procedure-all</artifactId>
